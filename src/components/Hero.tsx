  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="py-14 sm:py-20 lg:py-28 lg:grid lg:grid-cols-12 lg:gap-12 lg:items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="font-display font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-white tracking-tight">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-white/75 leading-relaxed max-w-xl">
            ...
            <div className="inline-flex items-start gap-3 px-4 py-3 rounded-xl bg-white/95 shadow-lg max-w-lg">
              <CheckCircle2 className="w-5 h-5 text-brand-red-500 flex-shrink-0 mt-0.5" strokeWidth={2.5} />
              <p className="text-sm sm:text-[15px] font-bold text-brand-navy leading-snug">

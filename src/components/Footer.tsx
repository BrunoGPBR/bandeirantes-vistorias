      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10">
          <div className="lg:col-span-5 md:col-span-2">
            <a href="#" className="inline-flex mb-4 sm:mb-5 max-w-full">
              <Image
                src="/logo.png"
                alt="Bandeirantes Vistorias Veicular"
                width={380}
                height={80}
                className="h-14 sm:h-20 md:h-24 w-auto max-w-full object-contain"
              />
            </a>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-11 h-11 rounded-xl bg-[#25D366] hover:bg-[#1EBE5D] flex items-center justify-center transition-colors flex-shrink-0"
                aria-label="WhatsApp"
              >
              ...
              <a
                ...
                className="w-11 h-11 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 flex items-center justify-center transition-colors flex-shrink-0"
                aria-label="Telefone"
              >
          ...
          <div className="lg:col-span-3 md:col-span-1">
            ...
            <div className="flex items-start gap-3">
              ...
              >
                <MapPin className="w-5 h-5 text-brand-blue-300 flex-shrink-0" strokeWidth={2.2} />
              </button>
              <div className="min-w-0 flex-1">
                <button
                  ...
                  className="text-left hover:text-brand-blue-200 transition-colors w-full"
                >
                  <p className="text-sm font-bold text-white leading-snug mb-0.5 break-words">
                    Av. Bandeirantes, 900 - Amambai
                  </p>
                  <p className="text-sm text-slate-400 break-words">Campo Grande / MS</p>
                  <p className="text-sm text-slate-400 break-words">CEP 79006-000</p>
                </button>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-white/[0.06] border border-white/10 flex items-center justify-center flex-shrink-0">
                  <Clock className="w-5 h-5 text-brand-blue-300 flex-shrink-0" strokeWidth={2.2} />
                </div>
                <div className="min-w-0 flex-1">
              ...
              <li className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-white/[0.06] border border-white/10 flex items-center justify-center flex-shrink-0">
                  <Phone className="w-5 h-5 text-brand-blue-300 flex-shrink-0" strokeWidth={2.2} />
                </div>
                <div className="min-w-0 flex-1">
                  <p className="text-[10px] font-bold tracking-wider text-slate-500 uppercase mb-0.5">
                    Contato
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm font-black text-white hover:text-brand-blue-200 transition-colors break-words"
                  >
                    (67) 3023-0044
                  </a>
                </div>
              ...
              <li className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-white/[0.06] border border-white/10 flex items-center justify-center flex-shrink-0">
                  <Scale className="w-5 h-5 text-brand-blue-300 flex-shrink-0" strokeWidth={2.2} />
                </div>
                <div className="min-w-0 flex-1">
                  <p className="text-[10px] font-bold tracking-wider text-slate-500 uppercase mb-0.5">
                    Regulamentação
        ...
        <div className="mt-8 sm:mt-12 lg:mt-14 pt-5 sm:pt-6 border-t border-white/10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            >
              <span className="w-5 h-5 rounded-full bg-gradient-to-br from-brand-blue-500 to-brand-red-500 flex items-center justify-center text-[10px] font-black text-white shadow flex-shrink-0">
                @
              </span>

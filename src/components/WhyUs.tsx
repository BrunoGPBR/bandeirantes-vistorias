      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-5">
          {reasons.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
              className="p-4 sm:p-5 rounded-2xl bg-white/[0.06] border border-white/10 hover:bg-white/[0.10] hover:border-white/20 transition-colors"
            >
              ...
              <h3 className="text-sm sm:text-base font-extrabold text-white mb-1.5 leading-snug">
                {title}
              </h3>

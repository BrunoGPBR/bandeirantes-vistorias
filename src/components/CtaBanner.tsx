    ...
    <section id="contato" className="py-14 sm:py-20 bg-gradient-to-br from-brand-blue-900 via-brand-blue-800 to-brand-blue-950 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-display font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-4 leading-tight">
            PRECISA FAZER UMA{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-10">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#25D366] text-white font-extrabold py-3.5 px-6 rounded-xl shadow-2xl shadow-emerald-500/25 hover:bg-[#1EBE5D] hover:shadow-emerald-500/50 hover:-translate-y-0.5 transition-all active:translate-y-0 text-sm sm:text-base"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-white/10 backdrop-blur border border-white/20 text-white font-bold py-3.5 px-6 rounded-xl hover:bg-white/15 hover:border-white/30 transition-all text-sm sm:text-base"
            >
              <Phone className="w-5 h-5 sm:w-5 sm:h-5" strokeWidth={2.2} />
              (67) 3023-0044
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/[0.06] backdrop-blur border border-white/10"
              >
                <div className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
                  <Icon className="w-5 h-5 text-white/85" strokeWidth={2.2} />
                </div>
